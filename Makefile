...
BYTEFILES=misc.cmo regexp.cmo automata.cmo lexer.cmo regexp2dfa.cmo commands.cmo parser.cmo
OPTFILES=misc.cmx regexp.cmx automata.cmx lexer.cmx regexp2dfa.cmx commands.cmx parser.cmx
