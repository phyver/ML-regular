...
BYTEFILES=misc.cmo regexp.cmo DFA.cmo NFA.cmo lexer.cmo regexp2dfa.cmo parser.cmo
OPTFILES=misc.cmx regexp.cmx DFA.cmx NFA.cmx lexer.cmx regexp2dfa.cmx parser.cmx
